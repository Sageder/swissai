...
export async function POST(req: Request) {
    try {
        ...
        if (!apiKey) {
            ...
            return new Response('OpenAI API key not configured. Please set OPENAI_API_KEY in your .env.local file.', { status: 500 });
        }
        ...
        const result = streamText({
            model: openai('gpt-4o-mini'), // Use gpt-4o-mini which is more reliable
